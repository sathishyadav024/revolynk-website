...
import Recent from "@/components/perspectives-inner/Recent";
import Blog from "@/components/perspectives-inner/Blog";
import Slider from "@/components/perspectives-inner/Slider";
