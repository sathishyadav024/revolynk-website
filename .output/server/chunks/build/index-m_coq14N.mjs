  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({
        ...
        "data-overlay-dark": "8"
      }, _attrs))}><div class="container"><div class="row justify-content-end"><div class="col-lg-6"><div class="text mb-100"><h4> We prioritizes in providing high-quality design and branding solutions to businesses and individuals. </h4></div></div></div></div><div class="container-fluid ontop"><div class="container"><div class="lg-text"><div class="d-flex"><h6>Together we</h6></div><h1>Invent the future...</h1></div></div></div></header>`);
    };
  }
};
...
//# sourceMappingURL=index-m_coq14N.mjs.map
