...
_sfc_main$5.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Linesli.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const Lines = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$4 = {
  __name: "ProgressScrollli",
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ProgressScrollli.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/cusorli.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/loaderli.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _imports_0$2 = "" + buildAssetsURL("light-logo.B2DjxcGg.webp");
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "min-footer sub-bg pt-30 pb-30" }, _attrs))}><div class="container"><div class="row"><div class="col-lg-4 col-md-6 md-mb15"><div class="logo icon-img-100"><img${ssrRenderAttr("src", _imports_0$2)} alt=""></div></div><div class="col-lg-4 order-md-3"><div class="text-center"><p class="fz-14"> \xA9 ${ssrInterpolate(_ctx.currentYear)} All Rights Reserved by <span class="underline main-color"><a href="https://www.revolynk.com"> Revolynk Techs Pvt. Ltd. </a></span></p></div></div><div class="col-lg-4 col-md-6 order-md-2 md-mb15"><div class="links d-flex justify-content-end"><ul class="rest d-flex align-items-center"><li><a href="/">Home Revolynk</a></li><li class="ml-30"><a href="/careers/careers-main">Careers</a></li><li class="ml-30"><a href="/about-us/contact-us">Contact Us</a></li></ul></div></div></div></div></footer>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Footerli.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Navbarlight.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _imports_0$1 = "" + buildAssetsURL("arrow-right.8iqq2Ti1.png");
const _imports_0 = "" + buildAssetsURL("s1.CCcFopil.png");
const _imports_1 = "" + buildAssetsURL("s2.CNdLUosC.png");
const _imports_2 = "" + buildAssetsURL("s3.0FEN9K3O.png");
const _imports_3 = "" + buildAssetsURL("s4.hnAYcnPb.png");
const data = [
  {
    img: "/light/assets/imgs/testim/t1.jpg",
    name: "Adam Beckley",
    subName: "Founder & CEO",
  ...
  {
    img: "/light/assets/imgs/testim/t2.jpg",
    name: "Adam Beckley",
    subName: "Founder & CEO",
    desc: "I have been hiring people in this space for a number of years and I have never seen this level of professionalism. It really feels like you are working  with a team that can get the job done"
  },
  {
    img: "/light/assets/imgs/testim/t3.jpg",
    name: "Adam Beckley",
    subName: "Founder & CEO",
    desc: "I have been hiring people in this space for a number of years and I have never seen this level of professionalism. It really feels like you are working  with a team that can get the job done"
  },
  {
    img: "/light/assets/imgs/testim/t4.jpg",
    name: "Adam Beckley",
    subName: "Founder & CEO",
    desc: "I have been hiring people in this space for a number of years and I have never seen this level of professionalism. It really feels like you are working  with a team that can get the job done"
  }
...
export { Footer as F, Lines as L, _sfc_main$2 as _, _sfc_main$3 as a, _sfc_main$4 as b, _sfc_main as c, _imports_0$1 as d, data as e, _imports_0 as f, _imports_1 as g, _imports_2 as h, _imports_3 as i };
//# sourceMappingURL=testimonials-BfKP-XKb.mjs.map
