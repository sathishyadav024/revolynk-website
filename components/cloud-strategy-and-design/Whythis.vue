            ...
            <div class="tab-content current" id="tabs-1">
              <div class="item">
                ...
                <div class="cont sub-bg">
                  ...
                  <div class="text">
                    <h6 class="sub-title mb-15 main-color">END-TO-END STRATEGY & DESIGN SOLUTIONS</h6>
                    <p>
                      From initial assessments to tailored architectures, we guide you through every phase of your cloud journey — ensuring each decision drives real value.
                    </p>
                  </div>
        ...
        <div class="col-lg-6 valign">
          <div class="serv-tab-link tab-links full-width pt-40">
            <div class="sec-head mb-30">
              <h6 class="sub-title mb-15 main-color">CLOUD STRATEGY & DESIGN</h6>
              <h2>Your path to the cloud, designed with clarity and purpose.</h2>
            </div>
            <div class="row justify-content-end">
              <div class="col-lg-11">
                <div class="text mb-50">
                  <p>
                    We craft cloud strategies that align with your business goals and design architectures that ensure agility, compliance, and long-term scalability across cloud environments.
                  </p>
                </div>
                <ul class="rest">
                  <li
