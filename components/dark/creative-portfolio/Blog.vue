<template>
  <section class="blog-crev section-padding sub-bg radius-30 mt-15">
    <div class="container">
      <div class="sec-head text-center mb-80">
        <h6 class="sub-title main-color mb-15">Latest News</h6>
        <h2>Look at the articles</h2>

        <div class="fixed-head main-bg">
          <h5 class="stroke">Blog</h5>
