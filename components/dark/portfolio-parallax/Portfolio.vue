  ...
  <section class="portfolio-fixed">
    <div class="container-fluid rest">
      <div style="position: relative" class="row">
        <div class="col-lg-6 rest" style="position: fixed">
          <div class="left sticky_item sticky-item">
            <div
              id="tab-1"
              style="height: 100vh"
              class="img bg-img"
        ...
        <div class="col-lg-6 sub-bg right">
          <div class="cont active" data-tab="tab-1">
            ...
            <span class="sub-title mb-15 main-color">01. Digital</span>
            <h2 class="mb-15">Luxury Glassware.</h2>
            <div class="row">
              <div class="col-md-9">
                <p>
                  We craft premium designs for agencies and global brands around
                  the globe.
                </p>
                <div class="vew-all mt-50">
                  <a href="/dark/project3" class="sub-title">
                    Explore More
                    <span>
                      <svg
                        width="18"
          ...
          <div class="cont" data-tab="tab-2">
            ...
            <span class="sub-title mb-15 main-color"> 02. Marketing </span>
            <h2 class="mb-15">Brand Identity.</h2>
            <div class="row">
              <div class="col-md-9">
                <p>
                  We craft premium designs for agencies and global brands around
          ...
          <div class="cont" data-tab="tab-3">
            ...
            <span class="sub-title mb-15 main-color">03. Design</span>
            <h2 class="mb-15">Roseville Pottery.</h2>
            <div class="row">
              <div class="col-md-9">
                <p>
                  We craft premium designs for agencies and global brands around
