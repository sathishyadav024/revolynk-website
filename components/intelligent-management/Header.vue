<template>
  ...
  >
        ...
        <div class="col-lg-10">
          <div class="caption">
            <div class="sub-title fz-12">
              ...
              <a href="#0">
                <span>Intelligent Management</span>
              </a>
            </div>
            <h1 class="fz-55 mt-30">
              Smart management solutions enabling bold brands to lead with precision.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      data-background="/dark/assets/imgs/blog/intelligent-management.png"
    ></div>
  </header>
</template>
<script setup>
