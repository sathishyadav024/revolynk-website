<template>
  ...
  >
        ...
        <div class="col-lg-10">
          <div class="caption">
            <div class="sub-title fz-12">
              ...
              <a href="#0">
                <span>Graphics Production</span>
              </a>
            </div>
            <h1 class="fz-55 mt-30">
              Striking visual content crafted to amplify bold brand stories.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      data-background="/dark/assets/imgs/blog/graphics-production.png"
    ></div>
  </header>
</template>
<script setup>
