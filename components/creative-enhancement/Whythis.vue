            ...
            <div class="tab-content current" id="tabs-1">
              <div class="item">
                ...
                <div class="cont sub-bg">
                  ...
                  <div class="text">
                    <h6 class="sub-title mb-15 main-color">END-TO-END CREATIVE ENHANCEMENT SOLUTIONS.</h6>
                    <p>
                      From concept refinement to multi-format production, we deliver creative strategies and assets that amplify brand identity, engagement, and impact.
                    </p>
                  </div>
            ...
            <div class="row justify-content-end">
              <div class="col-lg-11">
                <div class="text mb-50">
                  <p>
                    We enhance creative outputs with strategic thinking, cutting-edge tools, and multidisciplinary talent — helping brands stay fresh, relevant, and emotionally resonant in a dynamic world.
                  </p>
                </div>
                <ul class="rest">
                  <li
                  ...
                  >
                    <h3>
                      <span class="fz-18 opacity-7 mr-15">01</span> Motion Design
                    </h3>
                  </li>
                  <li
                    @click="openTab"
                  ...
                  >
                    <h3>
                      <span class="fz-18 opacity-7 mr-15">02</span> Design Systems
                    </h3>
                  </li>
                  <li
                    @click="openTab"
                  ...
                  >
                    <h3>
                      <span class="fz-18 opacity-7 mr-15">03</span> Creative Optimization
                    </h3>
                  </li>
