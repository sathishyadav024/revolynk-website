<template>
  <section class="portfolio-tab crev pb-50 pt-50" data-scroll-index="3">
    <div class="container">
      ...
      <div class="row">
        ...
        <div
          class="col-lg-5 offset-lg-1 d-flex align-items-center justify-content-center"
        >
          <div class="glry-img">
            <div
              id="tab-1"
