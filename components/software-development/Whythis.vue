            ...
            <div class="tab-content current" id="tabs-1">
              <div class="item">
                ...
                <div class="cont sub-bg">
                  ...
                  <div class="text">
                    <h6 class="sub-title mb-15 main-color">END-TO-END SOFTWARE SOLUTIONS</h6>
                    <p>
                      We plan, build, and maintain custom software with scalable architecture, robust performance, and business-aligned functionality.
                    </p>
                  </div>
        ...
        <div class="col-lg-6 valign">
          <div class="serv-tab-link tab-links full-width pt-40">
            <div class="sec-head mb-30">
              <h6 class="sub-title mb-15 main-color">SOFTWARE DEVELOPMENT</h6>
              <h2>Your vision, transformed into powerful software solutions.</h2>
            </div>
            <div class="row justify-content-end">
              <div class="col-lg-11">
                <div class="text mb-50">
                  <p>
                    We craft custom software tailored to your business needs — combining robust architecture, clean code, and seamless integration for scalable, future-ready systems.
                  </p>
                </div>
                <ul class="rest">
                  <li
                  ...
                  >
                    <h3>
                      <span class="fz-18 opacity-7 mr-15">03</span> API Integration
                    </h3>
                  </li>
