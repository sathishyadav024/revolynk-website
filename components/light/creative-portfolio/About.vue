<template>
  <section class="about-crev section-padding sub-bg radius-30 mt-15">
    <div class="sec-head">
      <div class="fixed-head main-bg">
        <h5 class="stroke">About Us</h5>
      ...
      <div class="row lg-marg">
            ...
            <div class="d-flex align-items-center">
              <div>
                <div class="info">
                  ...
                  <p class="nowrap">HR specialist</p>
                </div>
              </div>
              <div>
        ...
        <div class="col-lg-6 valign">
          <div class="content full-width">
            ...
            <div class="text">
              <p>
                We shifted our talents to frontier science because we wanted our
                work to have tangible, human-positive impact. Also, we get front
