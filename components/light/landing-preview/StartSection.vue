  ...
  <section class="works showcases thecontainer ontop sub-bg">
    ...
    <div class="panel">
      <div class="item">
        ...
        <a href="/light/showcase-fullscreen" class="plink" target="_blank"></a>
      </div>
    </div>
    ...
    <div class="panel">
      <div class="item">
        ...
        <a href="/light/showcase-carousel" class="plink" target="_blank"></a>
      </div>
    </div>
    ...
    <div class="panel">
      <div class="item">
        ...
        <a href="/light/showcase-half-slider" class="plink" target="_blank"></a>
      </div>
    </div>
