            ...
            <div class="tab-content current" id="tabs-1">
              <div class="item">
                ...
                <div class="cont sub-bg">
                  ...
                  <div class="text">
                    <h6 class="sub-title mb-15 main-color">END-TO-END INFRASTRUCTURE SOLUTIONS.</h6>
                    <p>
                      From infrastructure blueprinting to real-time monitoring and scaling, we build cloud foundations that are secure, flexible, and ready for anything.
                    </p>
                  </div>
            ...
            <div class="row justify-content-end">
              <div class="col-lg-11">
                <div class="text mb-50">
                  <p>
                    We design, deploy, and manage robust cloud infrastructures that support dynamic workloads, enable scalability, and ensure high availability for mission-critical systems.
                  </p>
                </div>
                <ul class="rest">
                  <li
