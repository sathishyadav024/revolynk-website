            ...
            <div class="tab-content current" id="tabs-1">
              <div class="item">
                ...
                <div class="cont sub-bg">
                  ...
                  <div class="text">
                    <h6 class="sub-title mb-15 main-color">END-TO-END SECURITY SOLUTIONS</h6>
                    <p>
                      From infrastructure and endpoint protection to facility access and surveillance, we design unified security frameworks that defend against both digital and physical threats.
                    </p>
                  </div>
        ...
        <div class="col-lg-6 valign">
          <div class="serv-tab-link tab-links full-width pt-40">
            <div class="sec-head mb-30">
              <h6 class="sub-title mb-15 main-color">CYBER-PHYSICAL SECURITY</h6>
              <h2>Your digital and physical environments, secured as one.</h2>
            </div>
            <div class="row justify-content-end">
              <div class="col-lg-11">
                <div class="text mb-50">
                  <p>
                    We integrate cybersecurity with physical security systems to protect critical assets, data, and operations — delivering end-to-end protection in an increasingly connected world.
                  </p>
                </div>
                <ul class="rest">
                  <li
                  ...
                  >
                    <h3>
                      <span class="fz-18 opacity-7 mr-15">01</span> Risk Assessment
                    </h3>
                  </li>
                  <li
                    @click="openTab"
                  ...
                  >
                    <h3>
                      <span class="fz-18 opacity-7 mr-15">03</span> Access Control
                    </h3>
                  </li>
