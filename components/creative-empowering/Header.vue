<template>
  ...
  >
        ...
        <div class="col-lg-10">
          <div class="caption">
            <div class="sub-title fz-12">
              ...
              <a href="#0">
                <span>Creative Empowering</span>
              </a>
            </div>
            <h1 class="fz-55 mt-30">
              Empowering creativity to inspire, engage, and elevate bold brands.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      data-background="/dark/assets/imgs/blog/creative-empowering.png"
    ></div>
  </header>
</template>
<script setup>
